...
<body class="JBody">
    ...
    <form method="post" action="management.php" class="add-form">
		<input type="submit" value="Return to management" class="return-col2">
	</form>
    ...
    <main class="JayMain">
        ...
        <section class="JaySection">
            ...
            $result1 = mysqli_query($conn, "SELECT id, title, description1, description2, list1, list2, list3, list4, list5, list6, list7, list8, asidelist1, asidelist2, asidelist3, asidelist4, asidelist5, asidelist6, link1, link2, link3, photo FROM activities WHERE id = 1");
			...
			<?php
				...
				$result1 = mysqli_query($conn, "SELECT id, title, description1, description2, list1, list2, list3, list4, list5, list6, list7, list8, asidelist1, asidelist2, asidelist3, asidelist4, asidelist5, asidelist6, link1, link2, link3, photo FROM activities WHERE id >= 8 ");
